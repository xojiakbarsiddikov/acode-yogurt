        ...
        <div class="grid">
            ...
            <div class="col-12 lg:col-10">
                <div class="grid formgrid p-fluid">
                    ...
                    <div class="field mb-4 col-12">
                        <label htmlFor="avatar" class="font-medium text-900"> Avatar </label>
                        <FileUpload mode="basic" name="avatar" url="./upload.php" accept="image/*" :maxFileSize="1000000" chooseLabel="Upload Image" class="p-button-outlined p-button-plain"></FileUpload>
                    </div>
                    <div class="field mb-4 col-12">
                        <label htmlFor="bio" class="font-medium text-900"> Bio </label>
                    ...
                    <div class="field mb-4 col-12 md:col-6">
                        <label htmlFor="city" class="font-medium text-900"> City </label>
                        <InputText id="city" type="text" />
                    </div>
                    <div class="field mb-4 col-12 md:col-6">
                        <label htmlFor="state" class="font-medium text-900"> State </label>
                        <InputText id="state" type="text" />
                    </div>
                    <div class="field mb-4 col-12">
                        <label htmlFor="website" class="font-medium text-900"> Website </label>
