        ...
        >
            <template #header>
                <div class="flex flex-wrap gap-2 align-items-center justify-content-between">
                    ...
                    <Button type="button" icon="pi pi-user-plus" label="Add New" class="p-button-outlined w-full sm:w-auto flex-order-0 sm:flex-order-1" @click="navigateToCreateListPage" />
                </div>
            </template>
            ...
            <Column field="representative.name" header="Created By" headerClass="white-space-nowrap" :style="{ width: '25%' }" sortable>
                <template #body="{ data }">
                    <div class="inline-flex align-items-center">
                        <img :alt="data.representative.name" :src="contextPath + `demo/images/avatar/${data.representative.image}`" class="w-2rem mr-2" />
